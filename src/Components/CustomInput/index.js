    ...
    <>
      <div className="inputWrapper">
        ...
        {props?.type === 'password'
          ...
          :
          <input type={props?.type} placeholder={props?.placeholder} required={props?.required} id={props?.id} name={props?.name} className={props?.inputClass} onChange={props?.onChange} value={props.value} disabled={props.disabled} accept={props?.accept}/>
        }
      </div>
    </>
  )
