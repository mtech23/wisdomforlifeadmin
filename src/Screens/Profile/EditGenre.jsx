...
export const EditGenre = () => {
    ...
    const GenreData = () => {
        ...
        fetch(`https://custom.mystagingserver.site/Tim-WDLLC/public/api/admin/genre_view/${id}`,
            {
                method: 'GET',
                headers: {
    ...
    const handleSubmit = (event) => {
        ...
        fetch(`https://custom.mystagingserver.site/Tim-WDLLC/public/api/admin/genre_add_update/${id}`, {
            method: 'POST',
            headers: {
                'Accept': 'application/json',
                'Authorization': `Bearer ${LogoutData}`
    ...
    return (
        <>
            <DashboardLayout>
                ...
                <CustomModal show={showModal} close={() => { setShowModal(false) }} success heading='Genre Update Successfully.' />
