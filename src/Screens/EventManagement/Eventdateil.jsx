...
console.log("datadetil" , data)
    ...
    useEffect(() => {
        ...
        document.title = 'Wissdom For Life | Event Detail';
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    <div className="productInfo">
                                        ...
                                        <p className="text-capitalize">{data?.event_date}</p>
                                          
                                        <p className="text-capitalize">{data?.cost}</p>
                                        <p className="text-capitalize">{data?.total_slots}</p>
                                      
                                        <p className="text-capitalize">{data?.short_description}</p>
                                        <p className="text-capitalize">{data?.days}</p>
